...
export default async function SingleAffiliatePage({ params }: { params: { slug: Array<string> } }) {
  ...
  const youtuberWithVideoId = filteredYtList.find((yt: TYoutuber) => yt.id.videoId);
      ...
      <div className="grid h-full w-full min-h-[100vh]">
        <div className="flex flex-col">
          <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="relative flex-col items-start gap-8 md:flex flex h-full max-h-screen">
                        ...
                        <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                          ...
                          <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0">
                            <Send
                              ...
                              profile={profile}
                              videoId={youtuberWithVideoId.id.videoId}
                              channelId={params.slug[0]}
