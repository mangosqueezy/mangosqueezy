			...
			<div className="max-w-[600px] m-auto my-20">
				...
				<div className="text-component line-height-lg v-space-md">
					<p className="leading-7 mt-8">
						Tapasom Inc ("us", "we", or "our") operates the mangosqueezy
					...
					<ul>
						...
						<li>
							...
							<p className="leading-7 mt-8">
								Tapasom use and transfer of information received from Google
								APIs to any other app will adhere to the Google API Services
								User Data Policy, including the Limited Use requirements. For
					...
					<p className="leading-7 mt-8">
						If you are from the European Economic Area (EEA), Tapasom Inc legal
					...
					<p className="leading-7 mt-8">
						Tapasom Inc may process your Personal Data because:
					</p>
					<ul>
					...
					<p className="leading-7 mt-8">
						Tapasom Inc will retain your Personal Data only for as long as is
					...
					<p className="leading-7 mt-8">
						Tapasom Inc will also retain Usage Data for internal analysis
					...
					<p className="leading-7 mt-8">
						Tapasom Inc will take all the steps reasonably necessary to ensure
					...
					<p className="leading-7 mt-8">
						If Tapasom Inc is involved in a merger, acquisition or asset sale,
					...
					<p className="leading-7 mt-8">
						Under certain circumstances, Tapasom Inc may be required to disclose
					...
					<p className="leading-7 mt-8">
						Tapasom Inc may disclose your Personal Data in the good faith belief
					...
					<p className="leading-7 mt-8">
						...
						certain data protection rights. Tapasom Inc aims to take reasonable
