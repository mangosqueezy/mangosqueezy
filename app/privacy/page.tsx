      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          <p className="leading-7 mt-8">
            Tapasom Inc ("us", "we", or "our") operates the mangosqueezy application (hereinafter
          ...
          <ul>
            <li>
              ...
              <p className="leading-7 mt-8">
                Service is the mangosqueezy application operated by Tapasom Inc
              </p>
            </li>
            <li>
              <p className="leading-7 mt-8">
            ...
            <li>
              <p className="leading-7 mt-8">
                <strong>Google API Service</strong>
              </p>
              <p className="leading-7 mt-8">
                Tapasom use and transfer of information received from Google APIs to any other app
                will adhere to the Google API Services User Data Policy, including the Limited Use
                requirements. For more details, please refer to the{" "}
                <a
          ...
          <h2>Use of Data</h2>
          <p className="leading-7 mt-8">
            Tapasom Inc uses the collected data for various purposes:
          </p>
          <ul>
          ...
          <p className="leading-7 mt-8">
            If you are from the European Economic Area (EEA), Tapasom Inc legal basis for collecting
          ...
          <p className="leading-7 mt-8">Tapasom Inc may process your Personal Data because:</p>
          <ul>
          ...
          <p className="leading-7 mt-8">
            Tapasom Inc will retain your Personal Data only for as long as is necessary for the
          ...
          <p className="leading-7 mt-8">
            Tapasom Inc will also retain Usage Data for internal analysis purposes. Usage Data is
          ...
          <p className="leading-7 mt-8">
            Tapasom Inc will take all the steps reasonably necessary to ensure that your data is
          ...
          <p className="leading-7 mt-8">
            If Tapasom Inc is involved in a merger, acquisition or asset sale, your Personal Data
          ...
          <p className="leading-7 mt-8">
            Under certain circumstances, Tapasom Inc may be required to disclose your Personal Data
          ...
          <p className="leading-7 mt-8">
            Tapasom Inc may disclose your Personal Data in the good faith belief that such action is
            necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Tapasom Inc</li>
          ...
          <p className="leading-7 mt-8">
            ...
            protection rights. Tapasom Inc aims to take reasonable steps to allow you to correct,
          ...
          <p className="leading-7 mt-8">The payment processors we work with are:</p>
          <ul>
            <li>
              <p className="leading-7 mt-8">
