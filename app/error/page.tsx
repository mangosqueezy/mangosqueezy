      ...
      <main className="grid my-12 place-items-center bg-white px-6 lg:px-8">
        <div className="mx-auto max-w-prose">
          ...
          <p className="mt-6 text-base leading-7 text-gray-600">
            ...
            <a href="mailto:amit@tapasom.com" className="leading-6 text-red-600">
              amit@tapasom.com
            </a>
            . Our team is always here to assist you and provide any information you need.
          </p>

          <p className="mt-6 text-base leading-7 text-gray-600">
            Once again, we apologize for the inconvenience and appreciate your patience and
            understanding.
          </p>
        </div>
      </main>
